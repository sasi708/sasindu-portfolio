...
export default function Home() {
  return (
    <PageWrapper>
      <section className="min-h-[calc(100vh-5rem)] flex items-center px-4 sm:px-8 md:px-24 py-12 md:py-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center w-full">

          {/* LEFT */}
          <div>
            <p className="text-yellow-400 tracking-widest font-semibold mb-4 text-xs sm:text-sm">
              UNDERGRADUATE · ICT
            </p>
            ...
            <div className="border border-yellow-400/60 rounded-xl p-4 sm:p-6 mb-6 max-w-xl">
...
With hands-on experience in Power BI dashboard development, data visualization, web development, and Software Quality Assurance (SQA), I enjoy transforming raw data into actionable insights and building modern web applications using current technologies.
            ...
            <div className="flex gap-4">
              <a
                ...
                download
                className="bg-yellow-400 text-black px-6 py-3 rounded-full font-semibold text-sm sm:text-base hover:opacity-90 transition">
              >
                Download CV
              </a>
            </div>
          ...
          <div className="relative flex justify-center">
            <motion.div
              className="absolute w-64 h-64 sm:w-80 sm:h-80 md:w-[420px] md:h-[420px] rounded-full bg-yellow-400 blur-3xl opacity-30"
              animate={{ opacity: [0.2, 0.5, 0.2] }}
              transition={{ duration: 3, repeat: Infinity }}
            />

            <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-[420px] md:h-[420px] rounded-full overflow-hidden border-4 border-yellow-400">
